...
const fixtures = [
    ...
    // TODO: make sure that number of requests is really asserted!
        ...
        it(f.provider, () => {
            ...
            cy.prefixedVisit('/accounts', {
                onBeforeLoad: (win: Window) => {
                    ...
                    cy.stub(win, 'fetch', rerouteMetadataToMockProvider(f.provider));
                },
            });
            ...
            cy.task('getRequests', { provider: f.provider }).then(requests => {
